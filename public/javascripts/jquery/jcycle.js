...
function buildOptions($cont, $slides, els, options, o) {
	...
	var opts = $j.extend({}, $j.fn.cycle.defaults, options || {}, $j.metadata ? $cont.metadata() : $j.meta ? $cont.data() : {});
	if (opts.autostop)
...
function exposeAddSlide(opts, els) {
	opts.addSlide = function(newSlide, prepend) {
		...
		if (opts.pager)
			$j.fn.cycle.createPagerAnchor(els.length-1, s, $(opts.pager), els, opts);
...
function buildPager(els, opts) {
	...
	$j.each(els, function(i,o) {
		$j.fn.cycle.createPagerAnchor(i,o,$p,els,opts);
	});
   $j.fn.cycle.updateActivePagerLink(opts.pager, opts.startingSlide);
};

$j.fn.cycle.createPagerAnchor = function(i, el, $p, els, opts) {
...
$j.fn.cycle.transitions.scrollUp = function($cont, $slides, opts) {
...
$j.fn.cycle.transitions.scrollDown = function($cont, $slides, opts) {
	$cont.css('overflow','hidden');
	opts.before.push($j.fn.cycle.commonReset);
	var h = $cont.height();
	opts.cssFirst = { top: 0 };
...
$j.fn.cycle.transitions.scrollLeft = function($cont, $slides, opts) {
	$cont.css('overflow','hidden');
	opts.before.push($j.fn.cycle.commonReset);
	var w = $cont.width();
...
$j.fn.cycle.transitions.scrollRight = function($cont, $slides, opts) {
	$cont.css('overflow','hidden');
	opts.before.push($j.fn.cycle.commonReset);
	var w = $cont.width();
	opts.cssFirst = { left: 0 };
...
$j.fn.cycle.transitions.scrollHorz = function($cont, $slides, opts) {
...
// slideX/slideY
$j.fn.cycle.transitions.slideX = function($cont, $slides, opts) {
	opts.before.push(function(curr, next, opts) {
		$(opts.elements).not(curr).hide();
...
$j.fn.cycle.transitions.slideY = function($cont, $slides, opts) {
	opts.before.push(function(curr, next, opts) {
		$(opts.elements).not(curr).hide();
...
// shuffle
$j.fn.cycle.transitions.shuffle = function($cont, $slides, opts) {
...
$j.fn.cycle.transitions.turnUp = function($cont, $slides, opts) {
	opts.before.push(function(curr, next, opts) {
		$j.fn.cycle.commonReset(curr,next,opts,true,false);
...
$j.fn.cycle.transitions.turnDown = function($cont, $slides, opts) {
	opts.before.push(function(curr, next, opts) {
		$j.fn.cycle.commonReset(curr,next,opts,true,false);
		opts.animIn.height = next.cycleH;
...
$j.fn.cycle.transitions.turnLeft = function($cont, $slides, opts) {
	opts.before.push(function(curr, next, opts) {
		$j.fn.cycle.commonReset(curr,next,opts,false,true);
...
$j.fn.cycle.transitions.turnRight = function($cont, $slides, opts) {
	opts.before.push(function(curr, next, opts) {
		$j.fn.cycle.commonReset(curr,next,opts,false,true);
		opts.animIn.width = next.cycleW;
...
// zoom
$j.fn.cycle.transitions.zoom = function($cont, $slides, opts) {
	opts.before.push(function(curr, next, opts) {
...
// fadeZoom
$j.fn.cycle.transitions.fadeZoom = function($cont, $slides, opts) {
	opts.before.push(function(curr, next, opts) {
...
// blindX
$j.fn.cycle.transitions.blindX = function($cont, $slides, opts) {
...
// blindY
$j.fn.cycle.transitions.blindY = function($cont, $slides, opts) {
...
// blindZ
$j.fn.cycle.transitions.blindZ = function($cont, $slides, opts) {
	var h = $cont.css('overflow','hidden').height();
	var w = $cont.width();
	opts.before.push(function(curr, next, opts) {
		$j.fn.cycle.commonReset(curr,next,opts);
...
$j.fn.cycle.transitions.growX = function($cont, $slides, opts) {
	opts.before.push(function(curr, next, opts) {
		$j.fn.cycle.commonReset(curr,next,opts,false,true);
...
$j.fn.cycle.transitions.growY = function($cont, $slides, opts) {
	opts.before.push(function(curr, next, opts) {
		$j.fn.cycle.commonReset(curr,next,opts,true,false);
...
$j.fn.cycle.transitions.curtainX = function($cont, $slides, opts) {
	opts.before.push(function(curr, next, opts) {
...
$j.fn.cycle.transitions.curtainY = function($cont, $slides, opts) {
	opts.before.push(function(curr, next, opts) {
...
$j.fn.cycle.transitions.cover = function($cont, $slides, opts) {
...
$j.fn.cycle.transitions.uncover = function($cont, $slides, opts) {
	var d = opts.direction || 'left';
	var w = $cont.css('overflow','hidden').width();
	var h = $cont.height();
	opts.before.push(function(curr, next, opts) {
...
$j.fn.cycle.transitions.toss = function($cont, $slides, opts) {
	var w = $cont.css('overflow','visible').width();
	var h = $cont.height();
	opts.before.push(function(curr, next, opts) {
		$j.fn.cycle.commonReset(curr,next,opts,true,true,true);
...
// wipe - clip animation
$j.fn.cycle.transitions.wipe = function($cont, $slides, opts) {
	var w = $cont.css('overflow','hidden').width();
	var h = $cont.height();
	opts.cssBefore = opts.cssBefore || {};
	var clip;
